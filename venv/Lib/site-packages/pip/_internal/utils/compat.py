...
def str_to_display(data, desc=None):
    ...
    :param desc: An optional phrase describing the input dataController, for use in
    ...
    We assume the dataController is in the locale preferred encoding. If it won't
    ...
    # Otherwise, dataController is a bytes object (str in Python 2).
    ...
    # Now try to decode the dataController - if we fail, warn the user and
