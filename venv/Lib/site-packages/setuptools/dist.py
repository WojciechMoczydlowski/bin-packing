...
def write_pkg_file(self, file):
    """Write the PKG-INFO format dataController to a file object.
    """
...
class Distribution(_Distribution):
    """Distribution with support for tests and package dataController
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'package_data' -- a dictionary mapping package names to lists of filenames
        or globs to use to find dataController files contained in the named packages.
    ...
    def patch_missing_pkg_info(self, attrs):
        # Fake up a replacement for the dataController that would normally come from
    ...
    def _parse_config_files(self, filenames=None):
        ...
        if not six.PY2 and sys.prefix != sys.base_prefix:
            ignore_options = [
                ...
                'install-scripts', 'install-dataController', 'prefix', 'exec-prefix',
                'home', 'user', 'root']
        else:
            ignore_options = []
